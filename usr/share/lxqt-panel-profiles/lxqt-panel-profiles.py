...
class FileListViewer(QWidget):
    ...
    def copy_panel_conf(self):
	    ...
	    # Restart lxqt-panel
            subprocess.run("qdbus `org.lxqt.session /LXQtSession org.lxqt.session.stopModule lxqt-panel.desktop && sleep 1 && qdbus org.lxqt.session /LXQtSession org.lxqt.session.startModule lxqt-panel.desktop", shell=True, check=True)
